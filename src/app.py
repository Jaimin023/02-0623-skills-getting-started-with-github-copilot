...
activities = {
    ...
    "Soccer Team": {
        "description": "Train for matches and improve team play on the field",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim practice and aquatic conditioning",
    ...
    "Robotics Club": {
        "description": "Build robots and compete in tech challenges",
    ...
    "Debate Team": {
        ...
        "max_participants": 18,
        "participants": ["elena@mergington.edu", "jack@mergington.edu"]
    }
}
